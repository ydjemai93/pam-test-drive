 ...
 */
type ProxyResponse = Record<string, unknown> | string;
/**
 ...
 */
declare function createBackendClient(opts: BackendClientOpts): BackendClient;
/**
 * A client for interacting with the Pipedream Connect API on the server-side.
 */
declare class BackendClient extends BaseClient {
    private oauthClient;
     ...
     */
    rawAccessToken(): string | Promise<string>;
    protected authHeaders(): string | Promise<string>;
    private ensureValidOauthAccessToken;
     ...
     * ```
     */
    createConnectToken(opts: ConnectTokenCreateOpts): Promise<ConnectTokenResponse>;
    /**
     ...
     * ```
     */
    getAccountById(accountId: string, params?: GetAccountByIdOpts): Promise<Account>;
    /**
     ...
     * ```
     */
    deleteAccountsByApp(appId: string): Promise<void>;
    /**
     ...
     * ```
     */
    deleteExternalUser(externalId: string): Promise<void>;
    /**
     ...
     */
    makeProxyRequest(proxyOptions: ProxyApiOpts, targetRequest: ProxyTargetApiRequest): Promise<ProxyResponse>;
}

export { type Account, type AccountsRequestResponse, type App, AppAuthType, type AppInfo, type AppRequestResponse, type AppResponse, type AppsRequestResponse, type AsyncRequestOptions, BackendClient, type BackendClientOpts, BaseClient, type ClientOpts, type ComponentConfigureOpts, type ComponentConfigureResponse, type ComponentId, type ComponentReloadPropsOpts, type ComponentRequestResponse, type ComponentType, type ComponentsRequestResponse, type ConfigurableProp, type ConfigurablePropAirtableBaseId, type ConfigurablePropAirtableFieldId, type ConfigurablePropAirtableTableId, type ConfigurablePropAirtableViewId, type ConfigurablePropAlert, type ConfigurablePropAny, type ConfigurablePropApp, type ConfigurablePropApphook, type ConfigurablePropBoolean, type ConfigurablePropDb, type ConfigurablePropDiscordChannel, type ConfigurablePropDiscordChannelArray, type ConfigurablePropHttp, type ConfigurablePropInteger, type ConfigurablePropIntegerArray, type ConfigurablePropObject, type ConfigurablePropSql, type ConfigurablePropString, type ConfigurablePropStringArray, type ConfigurablePropTimer, type ConfigurableProps, type ConfigureComponentOpts, type ConfigureComponentResponse, type ConfiguredProps, type ConnectAPIResponse, type ConnectTokenCreateOpts, type ConnectTokenResponse, DEBUG, type DeleteTriggerOpts, type DeployTriggerOpts, type DeployTriggerResponse, type ErrorResponse, type GetAccountByIdOpts, type GetAccountOpts, type GetAccountsResponse, type GetAppResponse, type GetAppsOpts, type GetAppsResponse, type GetComponentOpts, type GetComponentResponse, type GetComponentsOpts, type GetComponentsResponse, type GetTriggerEventsOpts, type GetTriggerEventsResponse, type GetTriggerOpts, type GetTriggerResponse, type GetTriggerWebhooksOpts, type GetTriggerWebhooksResponse, type GetTriggerWorkflowsOpts, type GetTriggerWorkflowsResponse, type GetTriggersOpts, type GetTriggersResponse, HTTPAuthType, type OAuthCredentials, type PaginationResponse, type ProjectEnvironment, type ProjectInfoResponse, type PropOption, type PropValue, type ProxyApiOpts, type ProxyResponse, type ProxyTargetApiOpts, type ProxyTargetApiRequest, type RelationOpts, type ReloadComponentPropsOpts, type ReloadComponentPropsResponse, type RequestOptions, type ResponsePageInfo, type RunActionOpts, type RunActionResponse, type TimerCron, type TimerInterval, type UpdateTriggerOpts, type UpdateTriggerWebhooksOpts, type UpdateTriggerWorkflowsOpts, type V1Component, type V1DeployedComponent, type V1EmittedEvent, createBackendClient };

...
async def entrypoint(ctx: JobContext):
    ...
    global outbound_trunk_id, appointment_time 
    ...
    # Use appointment_time from environment variable directly
    agent = OutboundCaller(
        name=first_name, 
        appointment_time=os.getenv("APPOINTMENT_TIME", "next Tuesday at 3pm"), # Get current value
        dial_info=dial_info, 
    )
